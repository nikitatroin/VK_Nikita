...
enum R {
    enum Storyboard {
        ...
        static let LoadView:UIStoryboard = .init(name: "LoadStoryboard", bundle: nil)
        static let Test:UIStoryboard = .init(name: "Test", bundle: nil)
    }
    ...
    enum Identifier {
        ...
        static let newsCell:String = .init("newsCell")
    }
}
