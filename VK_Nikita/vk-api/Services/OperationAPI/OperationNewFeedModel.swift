...
//
//   let newsFedd = try? newJSONDecoder().decode(NewsFedd.self, from: jsonData)

import Foundation

// MARK: - NewsFedd
struct NewsFedd: Codable {
...
// MARK: - PostSource
struct PostSources: Codable {
    let platform, type: String
}

// MARK: - Reposts
struct Repostss: Codable {
